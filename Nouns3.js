...
var intro = "Please select a Latin noun from the below list:" + "<br>" + "porta" + "&emsp;" + "silva" + "&emsp;" + "ancilla" + "&emsp;" + "villa" + "&emsp;" + "via" + "<br>" + "nuntius" + "&emsp;" + "servus" + "&emsp;" + "hortus" + "&emsp;" + "puer" + "&emsp;" + "templum" + "&emsp;" + "donum" + "&emsp;" + "triclinium" + "<br>" + "canis" + "&emsp;" + "pater" + "&emsp;" + "homo" + "&emsp;" + "leo" + "&emsp;" + "mater" +"<br>" + "corpus" + "&emsp;" + "tempus" + "&emsp;" + "vulnus" + "&emsp;" + "mare" + "<br>" + "animal" + "&emsp;" + "civis" + "&emsp;" + "mors" + "&emsp;" + "ars" + "&emsp;" + "hostis" + "<br>" + "manus" + "&emsp;" + "senatus" + "&emsp;" + "res" + "&emsp;" + "spes";


// "Please select a Latin noun from the below list:" + "<br>" + "amicus" + "&emsp;" + "ancilla" + "&emsp;" + "canis" + "<br>" + "civis" + "&emsp;" + "gladiator" + "&emsp;" + "homo" + "<br>" + "hortus" + "&emsp;" + "leo" + "&emsp;" + "mater" + "<br>" + "nuntius" + "&emsp;" + "pater" + "&emsp;" + "puer" + "<br>" + "pugna" + "&emsp;" + "servus" + "&emsp;" + "silva" + "<br>" + "via" + "&emsp;" + "villa" + "&emsp;" + "mare" + "<br>" + "templum" + "&emsp;" + "hostis" + "&emsp;" + "ars" + "<br>" + "manus" + "&emsp;" + "senatus" + "&emsp;" + "res" + "<br>" + "corpus" + "&emsp;" + "tempus" + "&emsp;" + "vulnus" + "<br>" + "mors" + "&emsp;" + "auris" + "&emsp;" + "spes";
...
function userNounInput(){
  ...
  var wordList = [["amicus","amici","m","friend","friends"],["ancilla","ancillae","f","maid servant","maid servants"],["animal","animalis","n","animal","animals"],["ars","artis","f","art","arts"],["auris","auris","f","ear","ears"],["canis","canis","m","dog","dogs"],["civis","civis","m","citizen","citizens"],["corpus","corporis","n","body","bodies"],["donum","doni","n","gift","gifts"],["gladiator","gladiatoris","m","gladiator","glaiators"],["hostis","hostis","m","enemy","enemies"],["homo","hominis","m","man","men"],["hortus","horti","m","garden","gardens"],["leo","leonis","m","lion","lions"],["manus","manus","f","hand","hands"],["mare","maris","n","sea","seas"],["mater","matris","f","mother","mothers"],["mors","mortis","f","death","deaths"],["nuntius","nuntii","m","messenger","messengers"],["pater","patris","m","father","fathers"],["porta","portae","f","gate","gates"],["puer","pueri","m","boy","boys"],["pugna","pugnae","f","fight","fights"],["res","rei","f","thing","things"],["senatus","senatus","m","senate","senates"],["servus","servi","m","slave","slaves"],["silva","silvae","f","forest","forests"],["spes","spei","f","hope","hopes"],["templum","templi","n","temple","temples"],["tempus","temporis","n","time","times"],["trinclinium","triclinii","n","dining room","dining rooms"],["via","viae","f","road","roads"],["villa","villae","f","house","houses"],["vulnus","vulneris","n","wound","wounds"]];
...
function startGame(){
  ...
  // [[ranNoun.accusativePl,ranNoun.accusativePlTrans,"accusative plural"]];
  // console.log(ranNounForm)
  // rNFindx = Math.floor(Math.random() * ranNounForm.length);
